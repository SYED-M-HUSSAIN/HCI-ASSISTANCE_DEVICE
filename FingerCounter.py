...
with mp_hands.Hands(
  ...
  while cap.isOpened():
    ...
    cv2.rectangle(image,(5,5),(720,110),(255,255,255),-1)
    cv2.putText(image,gesture,(20,50),cv2.FONT_HERSHEY_COMPLEX,1,(10,90,0),2)     
